...
void drawData(float x, float y, String abbrev) {
  ...
  color between = lerpColor(0,255, percent);
  fill(between);
...
void keyPressed(){
    if (key=='1') {
      save("US_map_centers_colors_1.jpg");
    }
    if (key=='2') {
      save("US_map_centers_colors_2.jpg");
    }
    if (key=='3') {
      save("US_map_centers_colors_3.jpg");
    }
    if (key=='4') {
      save("US_map_centers_colors_4.jpg");
    }
    if (key=='5') {
      save("US_map_centers_colors_5.jpg");
    }
    if (key=='6') {
      save("US_map_centers_colors_6.jpg");
    }
}
